        ...
        <section className={Styles.section}>
          <div className={Styles.aboutGrid}>
            <Fade bottom>
              <div>
                <img
                  src="image/shutterstock_1915346521-01.png"
            ...
            <Fade bottom>
              <div>
                <h2>ANTIREALITY INNOVATIVE SPATIAL SOLUTIONS CO & PARTNERS</h2>
                <p>
                  We create audacious brand experiences, for when SA brands need
                  a little more than traditional campaigns.
                </p>
              </div>
            </Fade>
          </div>
        ...
        <section className={Styles.section}>
          <div className={Styles.semiDubGrid}>
            <Fade bottom cascade delay={2000}>
              ...
              <div>
                <p>
                  Anti is a South African-based, innovative marketing and
                  development company, We’re simply creating experiential
                  campaigns and products that help brands achieve their
                  marketing objectives.
                </p>
                <p>
                  It’s not about the technology, it’s how we integrate it into
                  our campaigns.
                </p>
              </div>
            </Fade>
